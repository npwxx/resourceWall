...
const getResourcesByHighestRated = function() {
  ...
  GROUP BY resources.id, resources.title, resources.description, resources.resource_url
...
const getResourcesByMostCommented = function() {
  ...
  LEFT JOIN resource_ratings ON resources.id = resource_ratings.resource_id
  GROUP BY resources.id, resources.title, resources.description, resource_url, author
